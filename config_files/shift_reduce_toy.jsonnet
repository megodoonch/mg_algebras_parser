...
local validation_data_path = "data/processed/shift_reduce/toy/neural_input_shuffled.txt";  //"toy_dataset/toy-train.tsv";
...

{
  ...
  "trainer": {
    ...
    "optimizer": {
      "type": "adam",
      "lr": 0.01  // needs to be very small for BART; try 0.00002 (Jonas) (try 0.00001 for real data?)
      },
